import { Container, ContainerProps, AspectRatioProps, AspectRatio, Box, Heading, Text } from '@chakra-ui/react';
...
export const Hero = (props: ContainerProps & AspectRatioProps) => {
  return (
    <Container
      ...
      position={'relative'}
      overflow={'hidden'}>
      <AspectRatio ratio={16 / 9} width={['300%', null, '150%', null, '100%']} marginLeft={['-4px', null, '-3px', null, '0']}>
        {/* <IframeFacade
          Facade={() => (
            <TempImage
              priority
