    ...
    >
      <Flex gap={"1.5rem"}>
        ...
        >
          ...
          <Input value={first} onChange={handleInput} />
        ...
        >
          ...
          <Input value={last} onChange={handleInput} />
          <FormErrorMessage>Last name is required.</FormErrorMessage>
        </FormControl>
      </Flex>
      <Flex gap={"1.5rem"} marginTop={"2rem"}>
        <FormControl
          as={"fieldset"}
          isRequired
        ...
        >
          ...
          <Input value={phone} onChange={handleInput} />
      ...
      >
        ...
        <Input value={subject} onChange={handleInput} />
      ...
      <Button variant={"contact"} alignSelf={"flex-end"} marginTop={"2rem"}>
        Send Message
      </Button>
    </Flex>
  );
